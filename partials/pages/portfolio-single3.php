	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-8">
				...
				<div class="my-5">
					<img src="../../assets/images/portfolio/02.jpg" alt="" class="img-fluid w-100">
				</div>
				...
				<div class="mt-5">
					<a href="portfolio-single2.php" class="btn btn-dark">Previous Work</a>
					<a href="portfolio-single4.php" class="btn btn-dark">Next Work</a>
				</div>
			</div>
		</div>
	</div>
