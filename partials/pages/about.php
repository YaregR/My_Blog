		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-3">
				<div class="profile mb-5">
					<img src="../../assets/images/my_photo.jpg" alt="photo" class="img-fluid" width="200" >
				</div>
			</div>
			<div class="col-lg-9">
				<h2>Yaroslav Rudenko</h2>
				<p class="lead mb-4">I create designs and technology.</p>

				<p class="mb-4">I'm 42 years old web developer, specializing in Full Stack Web Development, Graphic Design and Printing Solutions for your projects.</p>

				<ul class="list-unstyled mt-3 mb-5 about-list">
					<li>- Development & CMS</li>
					<li>- Graphic Design</li>
					<li>- PrePress and Printing Solutions</li>
				</ul>
