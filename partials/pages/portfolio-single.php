...
<section class="section portfolio-single">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
				<img src="../../assets/images/portfolio/9.jpg" alt="" class="img-fluid w-100">
			</div>
		...
		<div class="row mt-5 justify-content-center">
			<div class="col-lg-6 text-center">
				<a href="portfolio-single4.php" class="btn btn-dark">Previous Work</a>
				<a href="portfolio-single2.php" class="btn btn-dark">Next Work</a>
			</div>
		</div>
	</div>
</section>
